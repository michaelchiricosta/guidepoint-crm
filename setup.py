...
body { background: #0a0e1a; color: #e2e8f0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 14px; overflow: hidden; }
...
input, textarea, select { font-family: inherit; font-size: 14px; color: #e2e8f0; background: #111827; border: 1px solid #1e2d40; border-radius: 6px; padding: 7px 10px; width: 100%; }
    ...
    try {
      const res = await fetch('https://api.anthropic.com/v1/messages',{
        ...
        body:JSON.stringify({
          ...
          system:'You are an account intelligence analyst for a cybersecurity sales rep at GuidePoint Security. Extract structured intel from input. Return ONLY valid JSON, no markdown.',
